...
时装杂志内页的气质：米白纸感底色、墨黑衬线大标题、大图为主角、克制的排版层级、唯一强调色。**照片永远比装饰重要。**
...
| Token | 浅色 | 深色 | 用途 |
|---|---|---|---|
| `paper` 背景 | `#FAF7F2` 米白 | `#141312` 墨纸 | 全局背景 |
| `surface` 卡片 | `#FFFFFF` | `#1F1D1B` | 卡片/弹层 |
| `ink` 主文字 | `#1A1A1A` | `#F2EFE9` | 标题/正文 |
| `inkFaint` 次级 | `#8A857D` | `#9C968C` | 序号/说明/占位 |
| `accent` 强调 | `#B5432A` 砖红 | `#D96A50` | 选中态/主按钮/FAB |
| `hairline` 分隔 | `#E8E2D9` | `#2C2926` | 细分隔线 |
