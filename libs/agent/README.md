...
- 当前进度：M0 spike + M1 传输层 + **M2 agent loop（2026-09-25 落地，63 单测绿）**已全部完成（[it-001](specs/iterations/it-001-agent-sdk-mvp.md) / [it-002](specs/iterations/it-002-agent-loop-m2.md)）；下一步 M3 = 消费方 app 接入（wardrobe it-041）
