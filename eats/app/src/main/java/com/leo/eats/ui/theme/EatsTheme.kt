...
fun EatsTheme(
    ...
    val colorScheme = if (darkTheme) {
        darkColorScheme(
            ...
            primaryContainer = Color(0xFF5C2A18),
            onPrimaryContainer = Color(0xFFF6DFD3),
            secondaryContainer = Color(0xFF2D2925),
            onSecondaryContainer = Color(0xFFD9D2C4),
        ...
        lightColorScheme(
            ...
            primaryContainer = Color(0xFFF9E4DB),
            onPrimaryContainer = Color(0xFF7A2E16),
            secondaryContainer = Color(0xFFF1E9DA),
            onSecondaryContainer = Color(0xFF4A443A),
